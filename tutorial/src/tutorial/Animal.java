...
// you can import libraries using import
import java.util.Scanner;
import java.util.*;

//A class defines the attributes (fields) and capabilities (methods)
...
public class Animal {
	...
	public static final double FAVNUM = 1.618;
	...
	public void setFavoriteChar() {
		...
		// and the values are int, byte, char, and String
		switch(randomNumber) {
			case 8:
	...
	public static void speakerAnimal(Animal randAnimal) {
